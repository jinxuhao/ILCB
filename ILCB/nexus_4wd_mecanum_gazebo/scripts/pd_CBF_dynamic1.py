...
if __name__ == '__main__':
	...
	while not rospy.is_shutdown():
		...
		#,1.0,0.0,-1.0,0.0,-2.*n22*x-1.*n21,-2.*n32*x-1.*n31,-2.*n42*x-1.*n41
		#,0.0,1.0,0.0,-1.0,+1.*n2y,+1.*n3y,+1.*n4y
		h = matrix([(c*h1-2.*(x-x_center_0)*(p_0_1)-2.*(y-y_center_0)*(q_0_1))*p_0_flag,(c*h2-2.*(x-x_center_1)*(p_1_1)-2.*(y-y_center_1)*(q_1_1))*p_1_flag,(c*h3-2.*(x-x_center_2)*(p_2_1)-2.*(y-y_center_2)*(q_2_1))*p_2_flag])
		# print('GX',[-2.*(x-x_center_0)*p_0_flag])
		sol = solvers.qp(P,q,G,h)
		...
		msg.linear.x = vx*0.4#0.23#0.03#0.05*math.cos(Theta_err)
		msg.linear.y = vy*0.4#0.23#0.03#0.05*math.sin(Theta_err)
